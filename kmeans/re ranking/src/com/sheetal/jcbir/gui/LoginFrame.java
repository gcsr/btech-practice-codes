 ...
 * @author : Thomas
 * 
 * This class is used for opening login page 
 * This class will check for swing thread events 
 * on input of username and password if credentials 
 * are correct we'll get tabular display
 */
		...
		btnLogin.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent event){
				...
				if((userName.equals("admin") && password.equals("admin"))){
					MainClassFrame frame=new MainClassFrame();
