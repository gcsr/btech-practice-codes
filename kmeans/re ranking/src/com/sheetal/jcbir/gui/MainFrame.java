...
import com.sheetal.jcbir.clustering.KMeans;
import com.sheetal.jcbir.duplicateimageremoval.ImageUtil;
import com.sheetal.jcbir.indexing.ClusterReader;
import com.sheetal.jcbir.indexing.ClusterWriter;
import com.sheetal.jcbir.indexing.Index;
import com.sheetal.jcbir.indexing.IndexReader;
import com.sheetal.jcbir.indexing.IndexWriter;
import com.sheetal.jcbir.search.ImageResult;
import com.sheetal.jcbir.search.ImageSearcher;
import com.sheetal.jcbir.util.GraphicsUtilities;
import com.sheetal.jcbir.util.ImageFileFilter;
...
public class MainFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        thumbnailPanel = new com.sheetal.jcbir.gui.JThumbnailPanel();
        ...
        thumbIndexPanel = new com.sheetal.jcbir.gui.JThumbnailPanel();
        ...
        jLabel1.setText("Image Re-Ranking");

        btnRemoveDuplicates.setText("Duplicates X");
        btnRemoveDuplicates.setName(""); // NOI18N
        btnRemoveDuplicates.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                btnRemoveDuplicatesMouseClicked(evt);
            }
        });
                ...
                .addGroup(queryPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, queryPanelLayout.createSequentialGroup()
                        ...
                        .addGroup(queryPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(btnRemoveDuplicates, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))
                .addContainerGap())
        );
        queryPanelLayout.setVerticalGroup(
            queryPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(imagePanel, javax.swing.GroupLayout.DEFAULT_SIZE, 188, Short.MAX_VALUE)
            .addGroup(queryPanelLayout.createSequentialGroup()
                .addGap(47, 47, 47)
        ...
        btnRemoveDuplicates.getAccessibleContext().setAccessibleName("Remove Duplicates");
        ...
        resultPanelLayout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, resultPanelLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(thumbnailPanel, javax.swing.GroupLayout.DEFAULT_SIZE, 197, Short.MAX_VALUE)
                .addGap(7, 7, 7)
        ...
        panel2=new ImagesDisplay(imagePathText);
		panel2.setBackground(Color.CYAN);
        cbirTab.addTab("Text Search",panel2);
        ...
        folderPanelLayout.setHorizontalGroup(
            ...
            .addGroup(folderPanelLayout.createSequentialGroup()
                ...
                .addGroup(folderPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(folderPanelLayout.createSequentialGroup()
                        .addComponent(folderText, javax.swing.GroupLayout.DEFAULT_SIZE, 702, Short.MAX_VALUE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        progressPanelLayout.setHorizontalGroup(
            ...
            .addGroup(progressPanelLayout.createSequentialGroup()
                ...
                .addGroup(progressPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(indexingStatusLabel, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 791, Short.MAX_VALUE)
                    .addComponent(indexProgress, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 791, Short.MAX_VALUE))
                .addContainerGap())
        );
        ...
        browsePanelLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, browsePanelLayout.createSequentialGroup()
                ...
                .addGroup(browsePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(thumbIndexPanel, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 791, Short.MAX_VALUE)
                    .addGroup(browsePanelLayout.createSequentialGroup()
                        .addComponent(browseIndexLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 242, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(browseIndexProgress, javax.swing.GroupLayout.DEFAULT_SIZE, 545, Short.MAX_VALUE))
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(cbirTab, javax.swing.GroupLayout.DEFAULT_SIZE, 658, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private void btnRemoveDuplicatesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnRemoveDuplicatesMouseClicked
        String filePath = imagePathText.getText().replace('\\', '/');
        if(filePath.isEmpty()){
            JOptionPane.showMessageDialog(null, "Please select the path.", "Error",
        ...
        imageUtils.removeDuplicates(directoryPath);
    }//GEN-LAST:event_btnRemoveDuplicatesMouseClicked
    ...
    private com.sheetal.jcbir.gui.JThumbnailPanel thumbIndexPanel;
    private com.sheetal.jcbir.gui.JThumbnailPanel thumbnailPanel;
