...
public class ShowDecryptedMessages extends JFrame implements WindowListener{
	public ShowDecryptedMessages(ArrayList<Message> messages){
    	...
    	while(itr.hasNext()){
    		...
    		if(! msg.getType().equals("chat")){
    			MainServer.processFile(msg.getFileName(),msg.getType(),msg.getData());
    		}
