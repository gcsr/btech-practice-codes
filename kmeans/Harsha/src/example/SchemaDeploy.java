...
public class SchemaDeploy {
    ...
    public static String ZIP_FILE = "deploy.zip";
    ...
    public static void main(String[] args) throws Exception {
        final String USERNAME = "practice@cloud.com";
        // This is only a sample. Hard coding passwords in source files is a bad practice.
        final String PASSWORD = "8880141616h"; 
        final String URL = "https://login.salesforce.com/services/Soap/c/30.0";
        
        SchemaDeploy sample = new SchemaDeploy(USERNAME, PASSWORD, URL);
        sample.deployZip();
    }
    
    public SchemaDeploy(String username, String password, String loginUrl) 
    ...
    private void createMetadataConnection( 
        ...
        System.out.println("Meta end point : " + loginResult.getMetadataServerUrl());
