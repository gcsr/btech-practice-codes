...
public class Strassen {
	...
	public int[][] multiply(int[][] A, int[][] B) {
		...
		if (n == 1)
			...
			m1=m1+7;//Since above 7 multiplications are performed 
	...
	public static void main(String[] args) {
		...
		System.out.println("Number of multiplications are:" +m1);
		System.out.println("Number of additions are:" +a1);
