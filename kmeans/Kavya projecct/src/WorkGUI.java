...
public class WorkGUI extends JFrame{
		...
		BackPropagation(){
			...
			startButton.addActionListener(new ActionListener(){
				public void actionPerformed(ActionEvent event){
					...
					if(ercot.isSelected()){
						options[0]="data/holidays/weekends/"+fileNumber+" train.arff";
						options[1]="data/holidays/weekends/"+fileNumber+" test.arff";
					}else{
						options[0]="data/holidays/weekends/"+fileNumber+" train.arff";
						options[1]="data/holidays/weekends/"+fileNumber+" test.arff";
					}
					...
					new BackPropagationThread(options).start();
	...
	private class ConjugateGradient extends JPanel{
		...
		public ConjugateGradient(){
			...
			hiddenField=new JTextField("Hidden Layers");
