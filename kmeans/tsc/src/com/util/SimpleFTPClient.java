...
public class SimpleFTPClient {
   ...
   public synchronized boolean uploadFile(InputStream is) {
    ...
    public synchronized boolean connect() {
        try {
        	String urlString="file:///" + user + ":" + password + "@" + host + "/" + remoteFile + ";type=i";
        	//String urlString="ftp://" + user + "@" + host + "/" + remoteFile + ";type=i";
            URL url = new URL(urlString);
            System.out.println("url is "+urlString);
            m_client = url.openConnection();
            System.out.println(">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>.."+"ftp://" + user +  "@" + host + "/" + remoteFile + ";type=i");
            return true;
