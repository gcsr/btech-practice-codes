...
public class draftFrame extends JFrame implements ActionListener, MouseListener, MouseMotionListener {
	...
	JButton newGameButton,pauseButton;
	...
	private void initGUI() {
		...
		jlayeredPane.setPreferredSize(new Dimension(600, 400));
        ...
        pauseButton.setBounds(420, 320,120,30);
        jlayeredPane.add(pauseButton);
        message.setText("There is no game in progress!");
        System.out.println("i draft home constructor");
    ...
    public void actionPerformed(ActionEvent evt) {
	     ...
	     if (src == newGameButton){
	    	 ...
	    	 String base=newGameButton.getText();
	    	 if(base.equals("New Game")){
	    		 
	    	 }else{
	    		 String derived=pauseButton.getText();
	    		 if(derived.equals("continue")){
	...
	public void mouseReleased(MouseEvent e) {
        ...
        if(playerPositionChanged){
        	System.out.println(" clientddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddd");
            board.setPlayerPosChange(true);
            playerPositionChanged = false;
        }
	}
    ...
    public boolean makeMove(int posX, int posY)
	{
        ...
        //System.out.println("after set to position");;
		...
		//System.out.println("after first set of if");;
		...
		if(oldROW<64 && oldCOL<64){
			...
			if(isJumpValid)
				...
				) && canMove(board.getPlayer(), oldROW, oldCOL, row, col))
				{
					...
					System.out.println("after can move");;
					chPiece.setVisible(false);
		            ...
		            if(oldROW<64 && oldCOL<64 && (oldROW!=row || oldCOL!=col)){
			            board.setBoardPiece(oldROW, oldCOL, 2);
			            board.setBoardPiece(row, col, board.getPlayer());
			            System.out.println("seboard piecec");;
		...
		System.out.println("before recreate board");;
