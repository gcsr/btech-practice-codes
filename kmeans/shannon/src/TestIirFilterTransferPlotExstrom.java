...
public static void main (String[] args) throws Exception {
   ...
   int filterOrder = Integer.parseInt(args[1]);
   double fcf1 = Double.parseDouble(args[2]);
   double fcf2 = Double.parseDouble(args[3]);*/
	
	
	
   //IirFilterCoefficients coeffs = IirFilterDesignExstrom.design(filterPassType, filterOrder, fcf1, fcf2);
   IirFilterCoefficients coeffs = IirFilterDesignExstrom.design(FilterPassType.lowpass, 3, .4, .0);
