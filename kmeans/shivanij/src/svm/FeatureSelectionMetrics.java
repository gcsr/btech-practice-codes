...
public class FeatureSelectionMetrics extends FeatureOccurrenceCounter {
  ...
  public static ArrayList<String> getList(String filePath) throws FileNotFoundException,Exception{
	  ArrayList<String> list=new ArrayList<String>();
	    BufferedReader br = new BufferedReader(new FileReader(filePath)) ;
		  
		  String line = br.readLine();
		  
		  FeatureSelectionMetrics fsm1 ;
		  Double mi1;
		  Double chiSquare1;
		  Double ig1;
		  ...
		  while (line != null) {
			  ...
			  fsm1= new FeatureSelectionMetrics(Double.parseDouble(tokens[0]), 
					  Double.parseDouble(tokens[1]), Double.parseDouble(tokens[2]), Double.parseDouble(tokens[3]));
			  mi1 = fsm1.getMI();
			  chiSquare1 = fsm1.getChiSquare();
			  ig1 = fsm1.getIG();		
			  s=mi1+","+chiSquare1+","+ig1+","+tokens[4];
			  list.add(s);			  
		      line = br.readLine();
		  }
  ...
  public static void writeToFile(ArrayList<String> list,String outputPath)throws FileNotFoundException,IOException{
