	...
	public void readPGM(String filename){
		...
		try {                        		    
		    ...
		    //System.out.println("file type is "+filetype);
	   	   	...
	   	   	System.out.println("Reading in image from " + filename + " of size " + rows + " by " + cols+" maxValue "+maxValue);
	   	   	// process the rest lines that hold the actual pixel values*/
	   	   	/*fileChars=infile.nextLine();
	   	   	fileChars=infile.nextLine();
	   	   	System.out.println(fileChars);
	   	   	char[] p=fileChars.toCharArray();*/
	   	   	String line;
	   	   	int i=0;
	   	   	...
	   	   	while(true){
	   	   		i++;
	   	   		line=infile.next();
	   	   		System.out.println(line.length()+" length is "+i);
	   	   		if(line==null)break;
	   	   		fileChars+=line;
	   	   	}
		...
		try{
			int j=0;
	   	   	System.out.println("file length is "+fileChars.length());
	   	   	char[] p=fileChars.toCharArray();
	   	   	for (int r=0; r<rows; r++) 
	   	   		for (int c=0; c<cols; c++){	
	   	   			pixels[r][c] = (int)(p[j]*255.0/maxValue);
	   	   			j++;
	   	   		}
	   	   	infile.close();
