...
public class DownloadManagerFrame1 extends JFrame {
	...
	public DownloadManagerFrame1()
	{
        ...
        chooseButton.addActionListener(new ActionListener(){
        	public void actionPerformed(ActionEvent event)
    		{
    			        ...
    			        int result=fileChooser.showSaveDialog(DownloadManagerFrame1.this);
        ...
        startButton.addActionListener(new ActionListener(){
        	public void actionPerformed(ActionEvent event)
    		{
    				...
    				try
    				{
    					...
    					mThread=new MainThread1(urlField.getText(),toField.getText(),threadField.getText());
