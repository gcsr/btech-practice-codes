...
<div id="templatmeo_container">
    ...
    <div id="templatemo_content">
		...
		<tr>
		<td><form name="form" method="post" action="search.jsp"><table width="300" height="200"  >
		
		 <tr> 
                  <td colspan="2" align="center"><strong><font  color="#FF0000" size="3">KeySearch 
                    </font></strong></td>
                </tr>
                <tr> 
                  <td ><font color="#FFFFFF"><strong>Enter KeyWord:</strong></font></td>
                  <td><input type="text" name="famousfor"></td>
                </tr>
                <tr> 
                  <td><input type="submit" value="Done" class="sub4"></td>
                  <td><input type="reset" value="Clear" class="sub5"></td>
                </tr>

		
		</table>
		</form>
		</td><td><img src="images/search.png" height="200" width="200"></td>
		</tr>
