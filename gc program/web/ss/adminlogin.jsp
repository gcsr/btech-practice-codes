...
<div id="templatmeo_container">
    ...
    <div id="templatemo_menu">
      ...
      <li><a href="" class="current"><span></span>Admin</a></li>
    ...
    <div id="templatemo_content">
		...
		<tr> 
                  <td><strong><font  color="#FFFFFF" size="+1" face="Times New Roman, Times, serif">Username:</font></strong></td>
	 ...
	 <tr> 
                  <td><input type="submit" value="done" class="sub3"></td>
		...
		</td><td><img src="images/admin.png"></td>
		</tr>
