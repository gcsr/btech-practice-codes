...
<div id="templatmeo_container">
    ...
    <div id="templatemo_menu">
      ...
      <li><a href="keysearch.jsp" ><span></span>Search</a></li>
	...
	<th><font color="#FFFFFF" size="+1"><strong>Hotels and its distances</strong></font></th>
      <tr> 
...
psmt1=con.prepareStatement("select * from hotel");
...
<tr> 
		  ...
		  <td><font  size="+1" style="times new roman" color="#FFFFFF"> <%="-"%> </font></td>
