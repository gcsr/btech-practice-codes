                                ...
                                <div class="entry">
                                    ...
                                    <table border="1" width="100%" cellpadding="0" cellspacing="0">
                                        ...
                                        <tr>
											...
											<td><a href="IntegrityCheck.jsp?fileName=<%=rs.getString("FILENAME")%> "> </a></td>
                                            <td><a href="FileDownload?filename=<%=rs.getString("FILENAME")%>" style="text-decoration: none;">Click Here</a></td>
