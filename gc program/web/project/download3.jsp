...
String m1=request.getParameter("by1");
	...
	String b2=null,m2=null; 
try
{
Connection con = databasecon.getconnection();
PreparedStatement ps=con.prepareStatement("select  block2,meta2 from fileupload where id='"+ccc+"' AND block2='"+block2+"'");
...
function validation()
{
var aa=document.s.block3.value;
if(aa=="")
{
alert("Enter secret key");
document.s.block3.focus();
return false;
}
}
</script>
...
<!-- content -->
		...
		%> <%=namew%></h2>
			<form action="download4.jsp" onSubmit="return validation()" name="s">
		<table>
		<tr> 
     ...
     <tr> 
		...
		<td><input type="text" name="by1" value="<%=m1%>" readonly=""></td>
			...
			<td>&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="block3"></td>
