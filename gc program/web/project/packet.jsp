...
PreparedStatement ps=con.prepareStatement("select ff,size from fileupload where id='"+ccc+"'");
...
<!-- content -->
		...
		%> <%=namew%></h2>
		<form action="send1.jsp" onSubmit="return validation()" name="s">
		<table>
		<tr> 
    ...
    <tr> 
              ...
              <td>&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="block1"></td>
		<td></td>
