...
String sat="sent to adminpasstpa";

int password=15;
StringBuffer sb = new StringBuffer();
for (int x = 0; x < password; x++)
{
...
String c=a+password1;


try
{
Connection con1 = databasecon.getconnection();
PreparedStatement ps1=con1.prepareStatement("update fileupload set enkey='"+c+"',status='"+sat+"' where id='"+ccc+"'");
ps1.executeUpdate();
...
<!-- content -->
			<section id="content"><div class="ic"></div>
				  ...
				  <%
		  String cccc=request.getQueryString();
...
PreparedStatement ps=con.prepareStatement("select fname,fid,size,date,id,status,owner,fileid,uid from fileupload where id='"+cccc+"'");
...
<tr>
<td><font color="#990000" size="+1">File Gen key:</font></td>
<td><input type="text" value="<%=c%>" readonly=""></td>
</tr>
<tr>
<td></td>
<td><a href="admin2.jsp?<%=id1%>"><font color="#FF0000" size="+2"><input type="button" value="Send to tpa"></font></a></td></tr>
