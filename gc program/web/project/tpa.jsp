...
<!-- content -->
		...
		<td width="200"></td>
		<td >
		<font color="#339900" size="+2">Auditor Login</font>
		<form id="user1" method="get" action="tpa1.jsp" name="s" onSubmit="return valid()">
			<table>
				<tr>
				<td>
		...
		<td><img src="images/tpa.jpg" width="100" height="100"></td></tr></table>
