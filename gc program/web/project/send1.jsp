...
String s1=(String)session.getAttribute("s1");
	...
	int as=Integer.parseInt(block1);
...
<!-- content -->
		...
		%> <%=namew%></h2>
			<form action="send2.jsp" onSubmit="return validation()" name="s">
		<table>
		<tr> 
    ...
    <tr> 
		...
		<td>&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="by1" value="<%=by%>" readonly=""></td>
            ...
            <tr> 
             ...
             <td>&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="block2"></td>
			 <td></td>
